...
/**
 * Utility class for handling OpenSearch index privileges.
 * This class defines various privilege constants and provides a method
 * to derive a privilege from a given action string.
 */
public class IndexPrivilegeUtils {
    // External Privileges for users

    /**
     * Represents the "all" privilege, granting all available permissions.
     */
    public static final String ALL                 = "all";

    /**
     * Represents the "monitor" privilege.
     */
    public static final String MONITOR             = "monitor";
    /**
     * Represents the "manage" privilege.
     */
    public static final String MANAGE              = "manage";
    /**
     * Represents the "view_index_metadata" privilege.
     */
    public static final String VIEW_INDEX_METADATA = "view_index_metadata";
    /**
     * Represents the "read" privilege.
     */
    public static final String READ                = "read";
    /**
     * Represents the "read_cross_cluster" privilege.
     */
    public static final String READ_CROSS_CLUSTER  = "read_cross_cluster";
    /**
     * Represents the "index" privilege.
     */
    public static final String INDEX               = "index";
    /**
     * Represents the "create" privilege, allowing creation operations.
     */
    public static final String CREATE              = "create";
    /**
     * Represents the "delete" privilege.
     */
    public static final String DELETE              = "delete";
    /**
     * Represents the "write" privilege.
     */
    public static final String WRITE               = "write";
    /**
     * Represents the "delete_index" privilege.
     */
    public static final String DELETE_INDEX        = "delete_index";
    /**
     * Represents the "create_index" privilege.
     */
    public static final String CREATE_INDEX        = "create_index";
    // Internal Privileges for Ranger authentication
    /**
     * Represents the internal "indices_put" privilege.
     */
    public static final String INDICES_PUT           = "indices_put";
    /**
     * Represents the internal "indices_search_shards" privilege.
     */
    public static final String INDICES_SEARCH_SHARDS = "indices_search_shards";
    /**
     * Represents the internal "indices_bulk" privilege.
     */
    public static final String INDICES_BULK          = "indices_bulk";
    /**
     * Represents the internal "indices_index" privilege.
     */
    ...
    static {
        // First Priority
        privileges.add(new IndexPrivilege(VIEW_INDEX_METADATA, Arrays.asList("indices:admin/aliases/get", "indices:admin/aliases/exists", "indices:admin/get", "indices:admin/exists", "indices:admin/mappings/fields/get", "indices:admin/mappings/get", "indices:admin/types/exists", "indices:admin/validate/query", "indices:monitor/settings/get")));
        privileges.add(new IndexPrivilege(READ, Arrays.asList("indices:data/read/")));
        privileges.add(new IndexPrivilege(READ_CROSS_CLUSTER, Arrays.asList("internal:transport/proxy/indices:data/read/")));
        ...
        // Last Priority
        privileges.add(new IndexPrivilege(ALL, Arrays.asList("indices:", "internal:transport/proxy/indices:", "cluster:")));
    }

    /**
     * No ArgConstructor to block instantiation.
     */
